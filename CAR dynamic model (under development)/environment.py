...
class Parking1:
    def __init__(self, car_pos):
        ...
        self.walls = [[70, i] for i in range(20, 90)] + \
                     [[30,i] for i in range(20,105)]+\
                     [[i,10] for i in range(30,36) ]+\
                     [[i,90] for i in range(70,76) ] #+ [[i,20] for i in range(-5,50)]

        # self.walls = [[70, i] for i in range(50, 70)] + \
        #              [[30, i] for i in range(50, 70)] + \
        #              [[i, 50] for i in range(30, 70)] + \
        #              [[i, 70] for i in range(30, 70)]
        ...
        # self.cars = {1: [35, 5], 2: [50, 5], 3: [65, 5], 4: [80, 5]}
    ...
    def make_car(self):
        ...
        # car_obstacle_x, car_obstacle_y = np.meshgrid(np.arange(-4, 4), np.arange(-2,2))  # modify meshgrid numbers to change obstacle orientation
